...
@dso_cache = dso_local local_unnamed_addr global [586 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 126191764, ; hash 0x7858894, from name: Proyecto ACSE
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 1353633002, ; hash 0x50aeccea, from name: libaot-Proyecto ACSE.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Proyecto ACSE.dll.so
		ptr null; void* handle (0x0)
	}, ; 162
	...
	%struct.DSOCacheEntry {
		i64 2920775793, ; hash 0xae178071, from name: Proyecto ACSE.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Proyecto ACSE.dll.so
		ptr null; void* handle (0x0)
	}, ; 393
	...
	%struct.DSOCacheEntry {
		i64 3021863714, ; hash 0xb41dfb22, from name: aot-Proyecto ACSE
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Proyecto ACSE.dll.so
		ptr null; void* handle (0x0)
	}, ; 408
	...
	%struct.DSOCacheEntry {
		i64 3278037431, ; hash 0xc362e1b7, from name: aot-Proyecto ACSE.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Proyecto ACSE.dll.so
		ptr null; void* handle (0x0)
	}, ; 451
	...
	%struct.DSOCacheEntry {
		i64 3451271911, ; hash 0xcdb63ae7, from name: libaot-Proyecto ACSE
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Proyecto ACSE.dll.so
		ptr null; void* handle (0x0)
	}, ; 474
